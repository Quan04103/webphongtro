    ...
    <div style={styles.container}>
      ...
      <div style={styles.body}>
        ...
        <div style={styles.room}>
          ...
          <button style={{ background: 'gray', marginLeft: '790px', fontSize: '30px', marginBottom: '50px',
        }}>Xem thêm</button>
        </div>
        <div style={styles.infor}>
              ...
              <span style={styles.text}>
                ...
                <p style={{textAlign: 'center',
                            ...
                            fontWeight: '700',
                            lineHeight: 'normal',
                            marginTop: '30px',}} >Chi phí thấp, hiệu quả tối đa</p>
              </span>
              ...
              <p style={{textAlign: 'center',
                            ...
                            lineHeight: 'normal',
                            marginTop: '30px',
                            marginBottom: '30px',}}>Không phải lo tìm người cho thuê, phòng trống kéo dài</p>
