...
const Footer = () => {
    return (
        <footer class="rounded-lg bg-[#5e90c6] text-center text-neutral-600 dark:bg-gray-600 dark:text-neutral-200 lg:text-left text-white">
        ...
        duration-200 ${!open && "hidden"
                    ...
                    <div>
                        ...
                        <img
                            ...
                            alt="VNPay"
                            className="h-60 w-60 inline-block mr-2"
                        />
                    </div>
                </div>
            </div>
