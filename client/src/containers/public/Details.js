        ...
        <div class="relative bg-white w-full h-auto  text-left text-5xl text-black font-inter">
            ...
            <div className="absolute top-[839px] left-[1097px] w-[336px] h-[351px] text-smi">
                ...
                <img
                    ...
                    src="{conheo}"
                />
                <div className="absolute top-[159px] left-[124px] inline-block w-[102.75px]">
                    Được đăng bởi
                </div>
                <b className="absolute top-[179px] left-[22px] text-2xl inline-block text-gray-300 w-[297.86px] h-[26.76px]">
                    huyheoheo123@gmail.com
                </b>
